	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www6.53kf.com/webCompany.php?arg=10038684&style=1&kflist=off&kf=764431942%40qq.com%2C1224480424%40qq.com%2C932916655%40qq.com%2C1805800505%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.baidiqing77.com%2F&keyword=http%3A%2F%2F127.0.0.1%3A5500%2Fshirouli%2Fhome%2Findex.html&brief=&logo=&question=&uid=60372f5a639ee62a8f31e5aa19ab348e";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" class=\"Lelem\" maxwidth=\"400\" maxheight=\"400\" minwidth=\"100\" minheight=\"100\" style=\"    position: relative; z-index: 10000; cursor: pointer;\" operating=\"null\"><div class=\"Lelem\" type=\"img\" eld_img=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428561.jpg\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; left: 0px; top: 0px; width: 390px; height: 190px; z-index: 10001;\"><img src=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428561.jpg\" style=\"width: 390px; height: 190px;\"></div><div class=\"Lelem\" type=\"img\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 0px; left: 369px; z-index: 10002; width: 21px; height: 21px;\" eld_img=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428819.jpg\"><img src=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428819.jpg\" style=\"width: 21px; height: 21px;\"></div><div class=\"Lelem\" type=\"img\" eld_img=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428857.jpg\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; left: 20px; top: 151px; width: 86px; height: 27px; z-index: 10003;\"><img src=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428857.jpg\" style=\"width: 86px; height: 27px;\"></div><div class=\"Lelem\" type=\"img\" eld_img=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428893.jpg\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; left: 119px; top: 151px; width: 89px; height: 27px; z-index: 10004;\"><img src=\"https://www6.53kf.com/img/upload/10038684/zdypic/box_100386841535428893.jpg\" style=\"width: 89px; height: 27px;\"></div></div>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
            ...
            var ivt_zdfq                = "yes";
            var ivt_poptime             = 3000;//邀请框延迟弹出
            var ivt_reauto				= "1";
			var ivt_reauto_time	        = 10000;
            var ivt_pop_page		 = "1";
			var ivt_pop_pagenum	= 100;
			var ivt_pop_total		= "1";
			var ivt_pop_totalnum = 100;


			var acc_from_kf			 = false;
			var hz6d_ivt_effect	 = "0";
			var hz6d_cname				= "&#20336;&#36842;&#28165;&#23448;&#26041;&#32593;&#31449;";
			var font_color;
			...
			var pc_ivt_top = "40";
			var pc_ivt_left = "50";
			var callback_id6ds = "10045163,10045151,10192102,10045169,10192103";
			...
			if (pc_ivt_type == '2' || pc_ivt_type == '-1') {
				$53.creElm({
					'id':'kfiframe',
					'src':'',
	    		...
	    		Inv.prototype = {
	    			...
	    			talk : function(){
	    				...
	    				if (zdfq_type == 3) {
	    					...
	    					var openurl = "https://www6.53kf.com/webCompany.php?arg=10038684&style=1&kflist=off&kf=764431942%40qq.com%2C1224480424%40qq.com%2C932916655%40qq.com%2C1805800505%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.baidiqing77.com%2F&keyword=http%3A%2F%2F127.0.0.1%3A5500%2Fshirouli%2Fhome%2Findex.html&brief=&logo=&question=&uid=60372f5a639ee62a8f31e5aa19ab348e&tfrom=2" + force_kf;
	    					onliner_zdfq=2;
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www6.53kf.com/style/chat/new2017/image/png/logo.png"/>'+
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72038684="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"https://www6.53kf.com/webCompany.php?arg=10038684&style=1&kflist=off&kf=764431942%40qq.com%2C1224480424%40qq.com%2C932916655%40qq.com%2C1805800505%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.baidiqing77.com%2F&keyword=http%3A%2F%2F127.0.0.1%3A5500%2Fshirouli%2Fhome%2Findex.html&brief=&logo=&question=&uid=60372f5a639ee62a8f31e5aa19ab348e&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www6.53kf.com/webCompany.php?arg=10038684&style=1&kflist=off&kf=764431942%40qq.com%2C1224480424%40qq.com%2C932916655%40qq.com%2C1805800505%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.baidiqing77.com%2F&keyword=http%3A%2F%2F127.0.0.1%3A5500%2Fshirouli%2Fhome%2Findex.html&brief=&logo=&question=&uid=60372f5a639ee62a8f31e5aa19ab348e&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72038684&style_id=106064322\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
